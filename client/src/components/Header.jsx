...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <motion.h1 className='text-4xl max-w-[300px] sm:text-7xl sm:max-w-[590px] mx-auto mt-10 text-center'>Turn test to <span className='text-blue-600 '
      initial={{opacity:0}}
      animate={{opacity:1}}
      ...
      <motion.button onClick={onClickHandler} className='sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full hover:scale-105 transition-all duration-500 cursor-pointer'
      ...
      <motion.div className='flex flex-wrap justify-center mt-6 gap-3'
      initial={{ opacity: 0}}
      animate={{ opacity: 1 }}
